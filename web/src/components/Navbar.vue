        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button
                        @click="cartStore.toggleDrawer()"
                        class="md:hidden relative flex items-center justify-center w-10 h-10 bg-white border-2 border-gold text-gold rounded-full hover:bg-gold hover:text-white transition-all duration-300"
                        aria-label="Panier"
                    >
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                        ...
                        <span
                            v-if="cartStore.itemsCount > 0"
                            class="absolute -top-1 -right-1 flex items-center justify-center w-4 h-4 text-[10px] font-bold text-white bg-gold rounded-full"
                        >
                            {{ cartStore.itemsCount > 99 ? '99+' : cartStore.itemsCount }}
                        </span>
                    </button>
