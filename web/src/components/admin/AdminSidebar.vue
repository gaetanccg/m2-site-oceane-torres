    ...
    >
        ...
        <div class="p-4 border-t border-gray-800">
            ...
            <router-link
                to="/"
                :class="[
          'flex items-center gap-3 w-full px-3 py-2 rounded-lg text-white hover:text-gold hover:bg-gray-800 transition-colors mb-2',
          isCollapsed ? 'justify-center' : ''
        ]"
            >
                <HomeIcon class="w-5 h-5" />
                <span v-if="!isCollapsed" class="text-sm font-medium">Retour à l'accueil</span>
            </router-link>
...
const EventIcon = () => h('svg', {class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24'}, [
    h('path', {'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'}),
...
const menuItems = [
    ...
    {path: '/admin/privacy', label: 'RGPD / Données', icon: ShieldIcon},
    {path: '/admin/logs', label: 'Logs', icon: LogsIcon},
]
</script>
