<template>
    <div class="pt-20 min-h-screen bg-gray-50">
        <!-- TODO: SUPPRIMER CE BLOC QUAND LE BACKEND EST DÉPLOYÉ -->
        <div class="fixed inset-0 top-20 bg-black/50 z-40 flex items-center justify-center p-4">
            <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
                ...
                <a
                    ...
                    target="_blank"
                    class="inline-flex items-center justify-center gap-2 w-full py-4 px-6 bg-gold text-white rounded-lg hover:opacity-90 transition-all font-medium"
                >
                    Accéder à la galerie externe
